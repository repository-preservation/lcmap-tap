...
class Ui_PyCCDPlottingTool(object):
    def setupUi(self, PyCCDPlottingTool):
        ...
        PyCCDPlottingTool.setTabOrder(self.xline, self.yline)
        PyCCDPlottingTool.setTabOrder(self.yline, self.browsecacheline)
    ...
    def retranslateUi(self, PyCCDPlottingTool):
        ...
        self.label_x.setText(_translate("PyCCDPlottingTool", "X"))
        self.label_y.setText(_translate("PyCCDPlottingTool", "Y"))
