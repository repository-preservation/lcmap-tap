...
class Ui_TAPTool(object):
    def setupUi(self, TAPTool):
        ...
        TAPTool.setTabOrder(self.comboBoxUnits, self.driveLetter_comboBox)
        TAPTool.setTabOrder(self.driveLetter_comboBox, self.version_comboBox)
        TAPTool.setTabOrder(self.version_comboBox, self.browsejsonline)
