...
class Ui_TAPTool(object):
    def setupUi(self, TAPTool):
        ...
        self.gridLayout_3.addLayout(self.outputverticalLayout, 0, 1, 12, 1)
        ...
        self.driveLetter_comboBox.setMinimumSize(QtCore.QSize(18, 0))
        self.driveLetter_comboBox.setMaximumSize(QtCore.QSize(64, 16777215))
        ...
        self.gridLayout_3.addWidget(self.cache_label, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_cache, 3, 0, 1, 1)
        self.json_label = QtWidgets.QLabel(self.centralwidget)
        self.json_label.setObjectName("json_label")
        self.gridLayout_3.addWidget(self.json_label, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_json, 5, 0, 1, 1)
        ...
        item = QtWidgets.QListWidgetItem()
        self.listitems.addItem(item)
        self.gridLayout_3.addWidget(self.listitems, 11, 0, 1, 1)
    ...
    def retranslateUi(self, TAPTool):
        ...
        self.driveLetter_comboBox.setCurrentText(_translate("TAPTool", "/lcmap_data"))
