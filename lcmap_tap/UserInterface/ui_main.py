...
class Ui_TAPTool(object):
    def setupUi(self, TAPTool):
        ...
        self.gridLayout_2.addLayout(self.outputverticalLayout, 0, 2, 7, 1)
        ...
        self.gridLayout_2.addWidget(self.output_label, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addLayout(self.horizontalLayout_plotsave, 6, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.radioshp, 8, 0, 1, 1)
        ...
        item = QtWidgets.QListWidgetItem()
        self.listitems.addItem(item)
        self.gridLayout_2.addWidget(self.listitems, 10, 0, 1, 2)
        ...
        TAPTool.setTabOrder(self.y1line, self.browsecacheline)
