...
class Ui_MainWindow_tap(object):
    def setupUi(self, MainWindow_tap):
        ...
        self.PushButton_saveconfig.setMinimumSize(QtCore.QSize(90, 0))
        self.PushButton_saveconfig.setMaximumSize(QtCore.QSize(90, 16777215))
        self.PushButton_saveconfig.setObjectName("PushButton_export")
        self.HBoxLayout_buttons.addWidget(self.PushButton_saveconfig)
    ...
    def retranslateUi(self, MainWindow_tap):
        ...
        self.PushButton_saveconfig.setText(_translate("MainWindow_tap", "Save Plot Config"))
