...
# Form implementation generated from reading ui file 'UI_MAIN_UPDATED.UI'
#
...
class Ui_MainWindow_tap(object):
    def setupUi(self, MainWindow_tap):
        ...
        self.gridLayout.addLayout(self.GridLayout_coordinates, 0, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.HBoxLayout_outputDir, 2, 0, 1, 1)
        self.Label_pyccdDir = QtWidgets.QLabel(self.centralwidget)
        self.Label_pyccdDir.setObjectName("Label_pyccdDir")
        self.gridLayout.addWidget(self.Label_pyccdDir, 3, 0, 1, 1)
        self.HBoxLayout_changeDir = QtWidgets.QHBoxLayout()
        self.HBoxLayout_changeDir.setObjectName("HBoxLayout_changeDir")
        self.LineEdit_changeDir = QtWidgets.QLineEdit(self.centralwidget)
        self.LineEdit_changeDir.setObjectName("LineEdit_changeDir")
        self.HBoxLayout_changeDir.addWidget(self.LineEdit_changeDir)
        self.PushButton_changeDir = QtWidgets.QPushButton(self.centralwidget)
        self.PushButton_changeDir.setMinimumSize(QtCore.QSize(35, 0))
        self.PushButton_changeDir.setMaximumSize(QtCore.QSize(25, 16777215))
        self.PushButton_changeDir.setObjectName("PushButton_changeDir")
        self.HBoxLayout_changeDir.addWidget(self.PushButton_changeDir)
        self.gridLayout.addLayout(self.HBoxLayout_changeDir, 4, 0, 1, 1)
        self.Label_classDir = QtWidgets.QLabel(self.centralwidget)
        self.Label_classDir.setObjectName("Label_classDir")
        self.gridLayout.addWidget(self.Label_classDir, 5, 0, 1, 1)
        self.HBoxLayout_classDir = QtWidgets.QHBoxLayout()
        self.HBoxLayout_classDir.setObjectName("HBoxLayout_classDir")
        self.LineEdit_classDir = QtWidgets.QLineEdit(self.centralwidget)
        self.LineEdit_classDir.setObjectName("LineEdit_classDir")
        self.HBoxLayout_classDir.addWidget(self.LineEdit_classDir)
        self.PushButton_classDir = QtWidgets.QPushButton(self.centralwidget)
        self.PushButton_classDir.setMinimumSize(QtCore.QSize(35, 0))
        self.PushButton_classDir.setMaximumSize(QtCore.QSize(25, 16777215))
        self.PushButton_classDir.setObjectName("PushButton_classDir")
        self.HBoxLayout_classDir.addWidget(self.PushButton_classDir)
        self.gridLayout.addLayout(self.HBoxLayout_classDir, 6, 0, 1, 1)
        ...
        item = QtWidgets.QListWidgetItem()
        self.ListWidget_items.addItem(item)
        self.gridLayout.addWidget(self.ListWidget_items, 7, 0, 1, 1)
        self.Label_results = QtWidgets.QLabel(self.centralwidget)
        self.Label_results.setObjectName("Label_results")
        self.gridLayout.addWidget(self.Label_results, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.PlainTextEdit_results, 9, 0, 1, 1)
        self.Label_selected = QtWidgets.QLabel(self.centralwidget)
        self.Label_selected.setObjectName("Label_selected")
        self.gridLayout.addWidget(self.Label_selected, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.ListWidget_selected, 11, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.HBoxLayout_buttons, 12, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow_tap):
        ...
        self.Label_pyccdDir.setText(_translate("MainWindow_tap", "Change Results Directory:"))
        self.PushButton_changeDir.setText(_translate("MainWindow_tap", "..."))
        self.Label_classDir.setText(_translate("MainWindow_tap", "Class Results Directory:"))
        self.PushButton_classDir.setText(_translate("MainWindow_tap", "..."))
