...
class Ui_TAP_Tool(object):
    def setupUi(self, TAP_Tool):
        TAP_Tool.setObjectName("TAP_Tool")
    ...
    def retranslateUi(self, TAP_Tool):
        ...
        TAP_Tool.setWindowTitle(_translate("TAP_Tool", "Time Series Analysis and Plotting Tool"))
        self.plotbutton.setText(_translate("TAP_Tool", "Plot"))
        self.savefigpushButton.setText(_translate("TAP_Tool", "Save Figure"))
        self.label_x.setText(_translate("TAP_Tool", "X"))
        self.label_y.setText(_translate("TAP_Tool", "Y"))
        self.browsecachebutton.setText(_translate("TAP_Tool", "..."))
        self.browsejsonbutton.setText(_translate("TAP_Tool", "..."))
        self.cache_label.setText(_translate("TAP_Tool", "Full path to cache folder:"))
        self.output_label.setText(_translate("TAP_Tool", "Output directory to save plots:"))
        self.radioshp.setText(_translate("TAP_Tool", "Create Point Shapefile on Plot"))
        self.json_label.setText(_translate("TAP_Tool", "Full path to JSON folder:"))
        self.browseoutputbutton.setText(_translate("TAP_Tool", "..."))
        __sortingEnabled = self.listitems.isSortingEnabled()
        self.listitems.setSortingEnabled(False)
        item = self.listitems.item(0)
        item.setText(_translate("TAP_Tool", "All Bands and Indices"))
        item = self.listitems.item(1)
        item.setText(_translate("TAP_Tool", "All Bands"))
        item = self.listitems.item(2)
        item.setText(_translate("TAP_Tool", "All Indices"))
        item = self.listitems.item(3)
        item.setText(_translate("TAP_Tool", "Blue"))
        item = self.listitems.item(4)
        item.setText(_translate("TAP_Tool", "Green"))
        item = self.listitems.item(5)
        item.setText(_translate("TAP_Tool", "Red"))
        item = self.listitems.item(6)
        item.setText(_translate("TAP_Tool", "NIR"))
        item = self.listitems.item(7)
        item.setText(_translate("TAP_Tool", "SWIR-1"))
        item = self.listitems.item(8)
        item.setText(_translate("TAP_Tool", "SWIR-2"))
        item = self.listitems.item(9)
        item.setText(_translate("TAP_Tool", "Thermal"))
        item = self.listitems.item(10)
        item.setText(_translate("TAP_Tool", "NDVI"))
        item = self.listitems.item(11)
        item.setText(_translate("TAP_Tool", "MSAVI"))
        item = self.listitems.item(12)
        item.setText(_translate("TAP_Tool", "EVI"))
        item = self.listitems.item(13)
        item.setText(_translate("TAP_Tool", "SAVI"))
        item = self.listitems.item(14)
        item.setText(_translate("TAP_Tool", "NDMI"))
        item = self.listitems.item(15)
        item.setText(_translate("TAP_Tool", "NBR"))
        item = self.listitems.item(16)
        item.setText(_translate("TAP_Tool", "NBR-2"))
        self.listitems.setSortingEnabled(__sortingEnabled)
        self.modelresultsLabel.setText(_translate("TAP_Tool", "Model Results:"))
        self.clickresultsLabel.setText(_translate("TAP_Tool", "Selected Observations:"))
        self.clearpushButton.setText(_translate("TAP_Tool", "Clear"))
        self.exitbutton.setText(_translate("TAP_Tool", "Close"))
