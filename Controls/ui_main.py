...
class Ui_PyCCDPlottingTool(object):
    def setupUi(self, PyCCDPlottingTool):
        ...
        PyCCDPlottingTool.resize(404, 832)
        ...
        self.gridLayout_main.addWidget(self.plainTextEdit_click, 21, 0, 1, 1)
        ...
        self.gridLayout_main.addItem(spacerItem, 18, 0, 1, 1)
        ...
        self.gridLayout_main.addItem(spacerItem1, 22, 0, 1, 1)
        ...
        self.gridLayout_main.addWidget(self.exitbutton, 23, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_main.addItem(spacerItem2, 2, 0, 1, 1)
